...
var OrderWhere = struct {
	...
	ProductID: whereHelperuint{field: "`orders`.`product_id`"},
...
var (
	orderAllColumns            = []string{"user_id", "product_id", "quantity"}
	orderColumnsWithoutDefault = []string{"user_id", "product_id", "quantity"}
	orderColumnsWithDefault    = []string{}
	orderPrimaryKeyColumns     = []string{"user_id", "product_id"}
)
...
func (q orderQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbx: failed to execute a one query for orders")
	}
...
func (q orderQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrderSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbx: failed to assign all query results to Order slice")
	}
...
func (q orderQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbx: failed to count orders rows")
	}
...
func (q orderQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbx: failed to check if orders exists")
	}
...
func (o *Order) SetProduct(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Product) error {
	...
	values := []interface{}{related.ID, o.UserID, o.ProductID}
...
func FindOrder(ctx context.Context, exec boil.ContextExecutor, userID uint, productID uint, selectCols ...string) (*Order, error) {
	orderObj := &Order{}
	...
	query := fmt.Sprintf(
		"select %s from `orders` where `user_id`=? AND `product_id`=?", sel,
	)

	q := queries.Raw(query, userID, productID)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbx: unable to select from orders")
	}
...
func (o *Order) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbx: no orders provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbx: unable to insert into orders")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbx: unable to populate default values for orders")
	}
...
func (o *Order) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbx: unable to update orders, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to update orders row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbx: failed to get rows affected by update for orders")
	}
...
func (q orderQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to update all for orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to retrieve rows affected for orders")
	}
...
func (o OrderSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to update all in order slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to retrieve rows affected all in update all order")
	}
	return rowsAff, nil
}
...
func (o *Order) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbx: no orders provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("dbx: unable to upsert orders, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbx: unable to upsert for orders")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbx: unable to retrieve unique values for orders")
	}
...
func (o *Order) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbx: no Order provided for delete")
	}
	...
	sql := "DELETE FROM `orders` WHERE `user_id`=? AND `product_id`=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to delete from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbx: failed to get rows affected by delete for orders")
	}
...
func (q orderQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbx: no orderQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to delete all from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbx: failed to get rows affected by deleteall for orders")
	}
...
func (o OrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbx: unable to delete all from order slice")
	}
...
func (o *Order) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindOrder(ctx, exec, o.UserID, o.ProductID)
	if err != nil {
		return err
	}
...
func (o *OrderSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbx: unable to reload all in OrderSlice")
	}
...
func OrderExists(ctx context.Context, exec boil.ContextExecutor, userID uint, productID uint) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `orders` where `user_id`=? AND `product_id`=? limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, userID, productID)
	}
	row := exec.QueryRowContext(ctx, sql, userID, productID)

	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbx: unable to check if orders exists")
	}
