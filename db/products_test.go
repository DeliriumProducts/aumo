...
var (
	productDBTypes = map[string]string{`ID`: `int`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `DeletedAt`: `timestamp`, `Name`: `varchar`, `Price`: `double`, `Image`: `varchar`, `Description`: `varchar`, `Stock`: `int`}
	_              = bytes.MinRead
)
