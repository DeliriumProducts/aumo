...
func (o *Order) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to populate default values for orders")
	}
...
func (o *Order) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for orders")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for orders")
	}
