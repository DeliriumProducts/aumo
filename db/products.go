...
func (o *Product) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to populate default values for products")
	}
...
func (o *Product) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for products")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for products")
	}
